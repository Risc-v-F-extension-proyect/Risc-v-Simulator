...
using Instr32 = ExtI::TypeR::Instr
    <InstrImpl, OpcodeID::OP, Funct3, funct3, Funct7::M_EXT>;

template <typename InstrImpl, Funct3 funct3>
using Instr64 = ExtI::TypeR::Instr
    <InstrImpl, OpcodeID::OP32, Funct3, funct3,Funct7::M_EXT>;
